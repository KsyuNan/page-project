    ...
    return (
        <section className={`${styles.Lisense}`}>
            ...
            <div className={` ${styles.LisenseContainerContent} flexColStart`}>
               <h3>Photography</h3>
               <p className={`inter`}>All images used in the <span>Pages</span> Webflow Template are licensed for free personal and commercial use. If you'd like to use any specific image, you <br/> can check the licenses and download the images for free on <span> <a href="https://unsplash.com/">Unsplash</a></span> , <span> <a href="https://www.pexels.com/"> Pexels.</a></span></p>
            ...
            <div className={`${styles.LisenseContainerContentUnsplash}`}>
                ...
                <ul className={`d-flex`}>
                    <li><a href="https://unsplash.com/photos/t8yimzM2bEY">Image 1, &nbsp;</a></li>
                    <li><a href="https://unsplash.com/photos/oRsSeYqJUgY">Image 2, &nbsp;</a></li>
                    <li><a href="https://unsplash.com/photos/p-th9JVqrkY">Image 3, &nbsp;</a></li>
                    <li><a href="https://unsplash.com/photos/edzkr3S1u60">Image 4 &nbsp;</a></li>
                </ul>
            </div>
            <div className={`${styles.LisenseContainerContentFonts}`}>
                <h3>Fonts</h3>
               <p>Pages template uses free licensed <span> <a href="https://fonts.google.com/">Google Fonts</a></span>. Please check <span><a href="https://fonts.google.com/specimen/Cardo#license">Cardo</a></span> and <span><a href="https://fonts.google.com/specimen/Inter#license">Inter</a></span>.</p>
            </div>
